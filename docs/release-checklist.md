...
Use this checklist before tagging `agentic-ecommerce-web` v9.0.0.
...
- `docs/v9-frontend-release-final.md` is ready to capture the v9.0.0 release evidence, skipped gates, and carry-forwards.
