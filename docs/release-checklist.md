# v7.5.1 Frontend Release Checklist

Use this checklist before tagging `agentic-ecommerce-web` v7.5.1.

## Version and Docs

- `package.json` contains version `7.5.1`.
- `CHANGELOG.md` includes the v7.5.1 release entry.
...
```bash
docker build -t ghcr.io/nfsarch33/agentic-ecommerce-web:${IMAGE_TAG:-v7.5.1} .
```
